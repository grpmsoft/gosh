...
const (
	// TypeExternal represents external OS commands (ls, cat, etc.).
...
// Redirection type constants for I/O redirection.
const (
	// RedirectInput represents input redirection N< (default 0<).
